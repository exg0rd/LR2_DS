...
"""
Простой тест для проверки интеграции FunkSVD
"""
...
if target_movie_id is not None:
    # Run FunkSVD algorithm with smaller parameters for faster execution
    funksvd_model, funksvd_predict_fn = funksvd_algorithm(ratings, n_factors=5, n_epochs=5, lr=0.005, reg=0.02)
